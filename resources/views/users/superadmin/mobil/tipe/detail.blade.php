...
@section('title')
{{$mobil->no_plat}} | {{$mobil->rental->nama}}
@endsection
...
<li class="breadcrumb-item"><a href="{{url('/superadmin/mobil')}}/{{$mobil->tipe_mobil_id}}">{{$mobil->tipe_mobil->nama}}</a></li>
                                    ...
                                    <div class="col-4">
                                        <div class="card">
                                            <img class="card-img-top img-responsive"
                                                src="<?=url('/')?>/public/upload/rental/{{$mobil->rental->id}}/img/mobil/{{$row->mobil_id}}/{{$row->foto}}"
                                                alt="{{$row->foto}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" action="{{url()->current()}}/foto-mobil/simpan" method="post">
                @csrf
                @method('PUT')
                <input type="hidden" name="rental_id" value="{{$mobil->rental->id}}" required>
