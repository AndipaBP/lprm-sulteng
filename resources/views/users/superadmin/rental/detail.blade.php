...
<li class="breadcrumb-item active" aria-current="page">{{$rental->nama}}</li>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#informasi-rental" role="tab"><span
            ...
            <div class="tab-content tabcontent-border">
                <div class="tab-pane active" id="akun" role="tabpanel">
                    <div class="p-4">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{url()->current()}}/akun/simpan" method="post">
                                    @csrf
                                    @method('PUT')
                                    <h3>Akun</h3>
                                    <hr>
                ...
                <div class="tab-pane" id="informasi-rental" role="tabpanel">
                    <div class="p-4">
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="no_hp" name="no_hp" required
                                                    maxlength="12" value="0{{$rental->nomor_hp}}"
                                                    placeholder="No. HP..">
                                            </div>
                                        </div>
                                    </div>
